const CONFIG = {
  ...
  HEO_HERO_TITLE_3: '268898.xyz',
  HEO_HERO_TITLE_4: '新版上线',
  HEO_HERO_TITLE_5: 'XiaoChao',
  HEO_HERO_TITLE_LINK: 'https://www.268898.xyz',
  // 英雄区遮罩文字
  HEO_HERO_COVER_TITLE: '随便逛逛',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '必看精选', url: '/tag/bkjx' },
  HEO_HERO_CATEGORY_2: { title: '热门文章', url: '/tag/rmwz' },
  HEO_HERO_CATEGORY_3: { title: '实用教程', url: '/tag/syjz' },
  ...
  HEO_SOCIAL_CARD_URL: 'https://www.268898.xyz',
